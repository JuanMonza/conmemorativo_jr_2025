        ...
        >
          <div className="text-center">
            <h3 className="text-3xl font-bold text-gray-800 mb-6">
              Memoria, Vida y Trascendencia
            </h3>
            <p className="text-lg text-gray-700 max-w-3xl mx-auto mb-8">
              Nuestro compromiso es crear un ambiente donde cada visita es un acto de amor y respeto. 
              Cada actividad, cada espacio, cada momento está diseñado para honrar vidas, fortalecer conexiones 
              y recordar que la trascendencia de quienes amamos vive en nuestros corazones y acciones.
            </p>
            <motion.a
              href="https://wa.me/573228147191?text=Hola,%20deseo%20conocer%20m%C3%A1s%20sobre%20las%20actividades%20y%20eventos%20en%20el%20Parque%20Conmemorativo%20Jardines%20del%20Renacer"
              target="_blank"
            ...
            >
              Conocer más sobre nuestros eventos
            </motion.a>
          </div>
        </motion.div>
      </div>
