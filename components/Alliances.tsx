  ...
  const benefits = [
    { 
      icon: <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
        <path d="M12 2L4 5v6.09c0 5.05 3.41 9.76 8 10.91 4.59-1.15 8-5.86 8-10.91V5l-8-3zm-1 15.5l-4-4 1.41-1.41L11 14.67l5.59-5.58L18 10.5l-7 7z"/>
      </svg>,
      title: "Beneficios de Salud", 
      description: "Acceso a servicios médicos y programas de bienestar para toda la familia" 
    },
    { 
      icon: <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
      ...
      description: "Talleres y capacitaciones para el desarrollo personal y familiar" 
    },
    { 
      icon: <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
      ...
      description: "Orientación legal y trámites administrativos sin complicaciones" 
    },
    { 
      icon: <svg className="w-12 h-12" fill="currentColor" viewBox="0 0 24 24">
      ...
      description: "Seguros y coberturas especiales para mayor tranquilidad" 
    }
  ];
    ...
    <section id="alianzas" className="py-20 bg-gradient-to-br from-blue-50 to-green-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold title-underline title-shadow"><span className="text-blue-600">Alianzas</span> <span className="text-emerald-600">Vive+</span></h2>
