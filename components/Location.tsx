    ...
    <section id="ubicacion" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
        >
          <div className="rounded-xl overflow-hidden shadow-2xl h-96 mb-8 border-4 border-white/50 backdrop-blur-sm">
            <iframe
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              <motion.div
                ...
                className="text-center p-6 bg-blue-50/90 backdrop-blur-lg rounded-xl shadow-lg hover:shadow-xl transition-all border-2 border-blue-100"
              >
